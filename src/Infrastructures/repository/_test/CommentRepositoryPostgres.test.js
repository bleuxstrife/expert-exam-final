...
describe('CommentRepositoryPostgres', () => {
  ...
  describe('checkIsLikesCommentExist function', () => {
    it('it should check return true when likes is exist', async () => {
      // Arrange
      const likesComment = {
        commentId: 'comment-123',
        owner: 'user-123',
    ...
    it('it should check return false when likes is not exist', async () => {
      // Arrange
      const likesComment = {
        commentId: 'comment-123',
        owner: 'user-123',
      ...
      await CommentsTableTestHelper.addComment({});
      await CommentLikesTableTestHelper.addCommentLikes({});
      await CommentLikesTableTestHelper.deleteCommentLikes({});
